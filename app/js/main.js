...
postcss__WEBPACK_IMPORTED_MODULE_1__.document.querySelectorAll('.option').forEach(function (optionWrapper) {
  ...
  listItem.forEach(function (listItem) {
    listItem.addEventListener('click', function (e) {
      ...
      Btn.focus();
      postcss__WEBPACK_IMPORTED_MODULE_1__.document.querySelector('.option__input-hidden').value = this.dataset.value;
      list.classList.remove('option__list--visible');
    });
  });
  // Клик снаружи дропдауна
  postcss__WEBPACK_IMPORTED_MODULE_1__.document.addEventListener('click', function (e) {
    if (e.target !== Btn) {
